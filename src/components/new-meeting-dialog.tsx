  ...
  return (
    <Dialog open={open} onOpenChange={setOpen}>
      ...
      <DialogContent className="sm:max-w-[480px]">
        <DialogHeader>
          <DialogTitle className="text-2xl font-bold">Start a new meeting</DialogTitle>
        </DialogHeader>
          ...
          <Tabs defaultValue="upload" className="w-full">
              ...
              <div className="grid w-full items-center gap-1.5">
                ...
                <div className="relative border-2 border-dashed border-muted-foreground/50 rounded-lg p-8 flex flex-col items-center justify-center text-center hover:border-primary transition-colors">
                    ...
                    <p className="mt-4 text-sm text-muted-foreground">
                        Drag & drop your file here or <span className="font-semibold text-primary">browse</span>
                    </p>
            ...
            <TabsContent value="record" className="py-4 text-center">
              <div className="flex flex-col items-center justify-center h-40">
                ...
                <p className="mt-4 text-lg font-semibold">Click to start recording</p>
                <p className="text-sm text-muted-foreground">Recording feature coming soon.</p>
              </div>
            </TabsContent>
            <TabsContent value="connect" className="py-4">
                <div className="space-y-4">
                    <p className="text-sm text-muted-foreground text-center">Connect your favorite meeting app. Coming soon.</p>
